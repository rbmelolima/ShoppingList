...
import 'package:shoppinglist/data/http/http.dart';
...
void main() {
  ...
  group('@post', () {
    test('Should call post with correct values', () async {
      ...
      verify(() => client.post(Uri.parse(url),
          headers: {'content-type': 'application/json', 'accept': 'application/json', 'any_header': 'any_value'}, body: '{"any_key":"any_value"}'));
    });
  ...
  group('@get', () {
    test('Should call get with correct values', () async {
      ...
      verify(
          () => client.get(Uri.parse(url), headers: {'content-type': 'application/json', 'accept': 'application/json', 'any_header': 'any_value'}));
    });
